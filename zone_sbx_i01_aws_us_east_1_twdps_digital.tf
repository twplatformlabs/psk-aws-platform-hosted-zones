...
provider "aws" {
  alias  = "subdomain_sbx_i01_aws_us_east_1_twdps_digital"
  region = "us-east-1"
  assume_role {
...
module "subdomain_sbx_i01_aws_us_east_1_twdps_digital" {
  ...
  providers = {
    aws = aws.subdomain_sbx_i01_aws_us_east_1_twdps_digital
  }

  zones = {
    "sbx-i01-aws-us-east-1.${local.domain_twdps_digital}" = {
      tags = {
  ...
  records = [
    {
      ...
      records         = lookup(module.subdomain_sbx_i01_aws_us_east_1_twdps_digital.route53_zone_name_servers,"sbx-i01-aws-us-east-1.${local.domain_twdps_digital}")
    }
  ]

  depends_on = [module.subdomain_sbx_i01_aws_us_east_1_twdps_digital]
}
