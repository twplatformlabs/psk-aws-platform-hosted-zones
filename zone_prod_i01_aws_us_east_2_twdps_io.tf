...
provider "aws" {
  alias  = "subdomain_prod_i01_aws_us_east_2_twdps_io"
  region = "us-east-2"
  assume_role {
...
module "subdomain_prod_i01_aws_us_east_2_twdps_io" {
  ...
  providers = {
    aws = aws.subdomain_prod_i01_aws_us_east_2_twdps_io
  }

  zones = {
    "prod-i01-aws-us-east-2.${local.domain_twdps_io}" = {
      tags = {
  ...
  records = [
    {
      ...
      records         = lookup(module.subdomain_prod_i01_aws_us_east_2_twdps_io.route53_zone_name_servers,"prod-i01-aws-us-east-2.${local.domain_twdps_io}")
    }
  ]

  depends_on = [module.subdomain_prod_i01_aws_us_east_2_twdps_io]
}
