...
moved {
  from = module.subdomain_preview_twplatformlabs_link.aws_route53_zone.this["preview.twplatformlabs.link"]
  to   = module.subdomain_preview_twplatformlabs_link.aws_route53_zone.this[0]
}
moved {
  from = module.subdomain_zone_delegation_preview_twplatformlabs_link.aws_route53_record.this["preview NS"]
  to   = module.subdomain_zone_delegation_preview_twplatformlabs_link.aws_route53_record.this["preview"]
}
