...
module "subdomain_prod_i01_aws_us_east_2_twplatformlabs_link" {
  ...
  zones = {
    "prod-i01-aws-us-east-2.${local.domain_twplatformlabs_link}" = {
      tags = {
  ...
  records = [
    {
      ...
      records         = module.subdomain_prod_i01_aws_us_east_2_twplatformlabs_link.route53_zone_name_servers["prod-i01-aws-us-east-2.${local.domain_twplatformlabs_link}"]
    }
  ]
