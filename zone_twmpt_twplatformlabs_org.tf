...
moved {
  from = module.subdomain_zone_delegation_twmpt_twplatformlabs_org.aws_route53_record.this["twmpt NS"]
  to   = module.subdomain_zone_delegation_twmpt_twplatformlabs_org.aws_route53_record.this["twmpt"]
}
